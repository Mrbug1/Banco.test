...
dic['users'] = str(input('Digite o nome de usuario: ')).strip()
dic['pass'] = str(input('Digite sua senha: ')).strip()
while len(dic['pass']) <= 3:
    print('Sua senhar é fraca!')
    dic['pass'] = str(input('Digite uma senha mais forte: ')).strip()
...
while dic['users'] != user or senh != dic['pass']:
    if blok == 2:
        print('Dados Bloqueados.')
        exit()
    blok += 1
    print(f'Após 3 tentativas incorretas sua conta sera apagada deste dispositivo. ')
    print(f'Tentativas restantes: { 3 - blok }')
    user = str(input('Digite seu nome de usuario: '))
    senh = str(input('Digite sua senha: '))

if user == dic['users'] and senh == dic['pass']:
    while True:
        print('========================')
        ...
        print('Precione [ 4 ] para feramentas.')
        print('Precione [ 5 ] para finalizar.')
        ...
        if resp == '1':
            ...
            if r == '1':
                ...
                print(f'Valor convertido de dólares americanos para R$: {n * 5.11}')
                print(f'Valor convertido de Euros para R$: {n * 5.55}')
                print('_' * 20)
        else:
            print('=' * 20)
            print('Volte sempre!')
